...
In this assignment, I used the \mintinline{python}{NaiveBayesClassifier} class from the NLTK library for Naive Bayes Classifier, and \mintinline{python}{SklearnClassifier} class from NLTK along with \mintinline{python}{SVC} class from scikit-learn for the Support Vector Classifier. I have tried various preprocessing operations, and logged the accuracy at each step, along with the confusion matrix and metrics such as precision.
