...
Surprizingly, this version made exactly the same decisions as the non-logarithm version. The results are shown in \autoref{fig:bayes_log_test} with green background.
